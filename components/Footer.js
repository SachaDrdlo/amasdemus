            ...
            <div className="container">
                <Grid container spacing={5} justify='space-between' className={styles.footer_container}>
                    ...
                    <Grid item xs={12} md={4} className={styles.footer_container_text}>
                        <h3>Amas Demus</h3>
                        <p>Amas Demus est un projet porté par la convivialité, la passion de la boisson et l'amour de la découverte. Nous espérons que cette expérience vous plaira!</p>
                        <span>
